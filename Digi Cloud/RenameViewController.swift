...
class RenameViewController: UITableViewController {
    ...
    fileprivate func setupViews() {
        ...
        leftBarButton = UIBarButtonItem(title: NSLocalizedString("Cancel", comment: "Button Title"), style: .done, target: self, action: #selector(handleCancel))
        rightBarButton = UIBarButtonItem(title: NSLocalizedString("Rename", comment: "Button Title"), style: .done, target: self, action: #selector(handleRename))
